// Event Onsubmit Form
// const submitAction = document.querySelector('#formDataDiri');

// submitAction.addEventListener('submit',(event)=>{
//     const inputNama= document.querySelector('#inputNama').value;
//     const inputDomisili= document.querySelector('#inputDomisili').value;
//     const hiddenMessage= 'Hallo ' + inputNama + ', bagaimana cuacanya di ' + inputDomisili

//     document.querySelector('#messageAfterSubmit').innerText=hiddenMessage
